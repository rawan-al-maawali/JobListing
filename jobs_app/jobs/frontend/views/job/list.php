...
<!-- ======= Hero Section ======= -->
  <section id="hero" class="d-flex align-items-center">
    <div class="container text-center position-relative" data-aos="fade-in" data-aos-delay="200">
      ...
      <h2>Being jobless is very frustrating. GUtech Jobs offer your a wide variety of jobs.</h2>
      <a href="#team" class="btn-get-started scrollto">View Jobs</a>
    </div>
  </section><!-- End Hero -->
...
<?php echo $this->render('_search',  ['model' => $searchModel]); ?>
    ...
    <section  id="team" class="team">
      <div class="container">
        <div class="row" >
          <div  style="font-size: 2em; width: 50%; padding: 10px; margin:auto; text-align: center;" class="col-lg-12">
            <div class="row">
             ...
             ?>
              ...
              <div class="col-lg-3">
                <div class="member" data-aos="zoom-in" data-aos-delay="100">
                  <div class="pic"><img src="<?= $products[$i]->job_picture ?>" class="img-fluid" alt=""></div>
                  <div class="member-info">
                    <h4><a href="<?= Url::to(['job/view', 'id'=>$products[$i]->id_job])?>"> <?= $products[$i]->title_job ?></a></h4>
                    <span><?= $products[$i]->type_job ?></span>
                    <span><?= $products[$i]->salary_job ?> OMR</span>
                    <p><?= $products[$i]->desc_job ?></p>
                    <div class="social">
      ...
      <div class="container">
        <div class="row">
          <div class="col-lg-4" data-aos="fade-right">
            <div style="display:block;" class="section-title">
              <h2>Contact us</h2>
            </div>
          </div>
